...
const Nav = () => {
  ...
  // const [hideHeadHunterNav, setHideHeadHunterNav] = useState(false);
  // const [hideJobSeekerNav, setHideJobSeekerNav] = useState(true);
...
{/* {!hideHeadHunterNav && */}
    <ul id='HeadHunterNav' className="flex flex-col mt-4 md:mt-0 font-medium md:flex-row md:space-x-8 ">
        ...
        <li>
            <a href="/create-eprofile" className="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Create Profile</a>
        </li>
        <li>
        ...
        <li>
            <a href="/profile" className="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">My Profile</a>
        </li>
        <li>
            <a href="/candidates-search" className="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">candidates(delete soon)</a>
        </li>
        <li>
...
{/* <div className='absolute right-48 top-4 md:top-10'>
 <Link href='/headhunters' className=" border border-purple-600  text-md font-medium text-purple-600   hover:bg-gray-100 rounded-md py-2 px-4">Head Hunters
  </Link>
...
<div className='absolute right-3 top-4 md:top-10'>
      {session?.user ? (
        ...
        Object.values(providers).map((provider) => (
          ...
          className='block py-3 px-6 rounded-lg bg-blue-500 mr-10 text-white mt-[-10px]'
          >
            Sign In
          </button>
        ))
