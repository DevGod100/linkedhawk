...
<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4" ref={navRef}>
...
<label className="relative inline-flex items-center cursor-pointer">
  ...
  <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Job Seekers</span>
</label>
</div>
